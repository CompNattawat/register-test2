      ...
      <ul class="nav navbar-nav navbar-menu">
        ...
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">ข้อมูลหลัก <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li class="dropdown-submenu"><a href="#">โครงสร้างโรงเรียน <span class="caret-right"></span></a>
              <ul class="dropdown-menu">
                <li ><a href="{{ url.getBaseuri() }}maindata/classgroup" data-id="1" data-name="ข้อมูลช่วงชั้น" class="menu_list"> ข้อมูลช่วงชั้น</a></li>
                <li ><a href="{{ url.getBaseuri() }}maindata/classlevel" data-id="2" data-name="ข้อมูลระดับ" class="menu_list"> ข้อมูลระดับ</a></li>
              </ul>
            </li>
            <li class="dropdown-submenu"><a href="#">ข้อมูลหลักทะเบียน <span class="caret-right"></span></a>
              <ul class="dropdown-menu">
                <li><a href="{{ url.getBaseuri() }}maindata/subjectgroup" class="menu_list">ข้อมูลกลุ่มสาระวิชา</a></li>
        ...
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">ระเบียน <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="{{ url.getBaseuri() }}recorddata/studentdata" >ข้อมูลนักเรียน</a></li>
          </ul>
        </li>
        <li class="dropdown">
