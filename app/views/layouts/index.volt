        ...
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">ข้อมูลหลัก <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li class="dropdown-submenu"><a href="#">โครงสร้างโรงเรียน <span class="caret-right"></span></a>
              <ul class="dropdown-menu">
                <li class="submenu"><a href="#" data-id="1" data-name="ข้อมูลช่วงชั้น" class="menu_list"> ข้อมูลช่วงชั้น</a></li>
                <li class="submenu"><a href="#" data-id="2" data-name="ข้อมูลระดับ" class="menu_list"> ข้อมูลระดับ</a></li>
              </ul>
            </li>
